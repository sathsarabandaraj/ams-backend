...
export const createStudent = async (
    ...
    try {
        ...
        const newUser = userRepository.create({
            ...userData,
            systemId: sysIdGenerator(centerData?.code, UserType.STUDENT),
        ...
        throw new Error(
            error instanceof Error ? error.message : 'student.studentCreationFailed'
        )
    } finally {
...
export const getAllStudents = async (
    ...
    try {
        ...
        throw new Error(
            error instanceof Error ? error.message : 'student.studentsRetrievalFailed'
        )
    }
}
...
export const getStudentByUUID = async (
    ...
    try {
        ...
        throw new Error(
            error instanceof Error ? error.message : 'student.studentRetrievalFailed'
        )
    }
}
...
export const updateStudent = async (
    ...
    try {
        ...
        await queryRunner.rollbackTransaction()
        throw new Error(
            error instanceof Error ? error.message : 'student.studentUpdateFailed'
        )
    } finally {
...
export const deleteStudent = async (
    ...
    try {
        ...
        await queryRunner.rollbackTransaction()
        throw new Error(
            error instanceof Error ? error.message : 'student.studentDeletionFailed'
        )
    } finally {
        // Always release the query runner
        await queryRunner.release()
